...
class FileProviderAdapterGetItemTests: FileProviderAdapterTestCase {
	...
	func testGetFileProviderItem() throws {
		let id: Int64 = 2
		let itemMetadata = ItemMetadata(id: id, name: "TestItem", type: .file, size: 100, parentID: NSFileProviderItemIdentifier.rootContainerDatabaseValue, lastModifiedDate: nil, statusCode: .isUploaded, isPlaceholderItem: false)
	...
	func testGetFileProviderItemWithUploadError() throws {
		let id: Int64 = 2
		let itemMetadata = ItemMetadata(id: id, name: "TestItem", type: .file, size: 100, parentID: NSFileProviderItemIdentifier.rootContainerDatabaseValue, lastModifiedDate: nil, statusCode: .uploadError, isPlaceholderItem: true)
		metadataManagerMock.cachedMetadata[id] = itemMetadata
