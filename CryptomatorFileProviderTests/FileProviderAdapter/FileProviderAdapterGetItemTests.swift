...
class FileProviderAdapterGetItemTests: FileProviderAdapterTestCase {
	...
	func testGetFileProviderItem() throws {
		let id: Int64 = 2
		let itemMetadata = ItemMetadata(id: id, name: "TestItem", type: .file, size: 100, parentId: MetadataDBManager.rootContainerId, lastModifiedDate: nil, statusCode: .isUploaded, cloudPath: CloudPath("/TestItem"), isPlaceholderItem: false)
	...
	func testGetFileProviderItemWithUploadError() throws {
		let id: Int64 = 2
		let itemMetadata = ItemMetadata(id: id, name: "TestItem", type: .file, size: 100, parentId: MetadataDBManager.rootContainerId, lastModifiedDate: nil, statusCode: .uploadError, cloudPath: CloudPath("/TestItem"), isPlaceholderItem: true)
		metadataManagerMock.cachedMetadata[id] = itemMetadata
