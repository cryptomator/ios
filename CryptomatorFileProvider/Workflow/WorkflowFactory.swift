...
enum WorkflowFactory {
	static func createWorkflow(for deletionTask: DeletionTask, provider: CloudProvider, metadataManager: MetadataManager) -> Workflow<Void> {
	...
	static func createWorkflow(for uploadTask: UploadTask, provider: CloudProvider, metadataManager: MetadataManager, cachedFileManager: CachedFileManager, uploadTaskManager: UploadTaskManager) -> Workflow<FileProviderItem> {
	...
	static func createWorkflow(for downloadTask: DownloadTask, provider: CloudProvider, metadataManager: MetadataManager, cachedFileManager: CachedFileManager) -> Workflow<FileProviderItem> {
	...
	static func createWorkflow(for reparenTask: ReparentTask, provider: CloudProvider, metadataManager: MetadataManager, cachedFileManager: CachedFileManager, reparentTaskManager: ReparentTaskManager) -> Workflow<FileProviderItem> {
