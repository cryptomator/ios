...
public enum CloudAccessSecrets {
    ...
    public static let boxRedirectURIScheme = "${BOX_CLIENT_REDIRECT_URI_SCHEME}"
    public static let boxRedirectURI = "boxsdk-${BOX_CLIENT_REDIRECT_URI_SCHEME}://boxsdkoauth2redirect"
